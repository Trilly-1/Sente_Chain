...
export default function AdminDashboard() {
  ...
  const inp = (e={}) => ({ background:"#f9fafb", border:`1.5px solid ${T.border}`, color:T.textHi, borderRadius:"9px", padding:"11px 14px", width:"100%", outline:"none", fontSize:"14px", fontFamily:T.font, transition:"border-color 0.18s, box-shadow 0.18s", ...e })
          ...
          <div>
            ...
            <div style={{ ...cardMd(), overflow:"hidden" }}>
              <div style={{ padding:"18px 24px", borderBottom:`1.5px solid ${T.border}`, background:"#fff" }}>
                <h2 style={{ fontSize:"17px", fontWeight:800, color:T.textHi, margin:0 }}>Recent Transactions All Members</h2>
              </div>
          ...
          <div style={{ ...cardMd(), overflow:"hidden" }}>
            <div style={{ padding:"18px 24px", borderBottom:`1.5px solid ${T.border}`, display:"flex", justifyContent:"space-between", alignItems:"center", background:"#fff" }}>
              ...
              <input type="text" placeholder="Search..." value={search} onChange={e=>setSearch(e.target.value)}
                style={{ padding:"9px 14px", borderRadius:"9px", border:`1.5px solid ${T.border}`, background:"#f9fafb", color:T.textHi, fontSize:"14px", fontFamily:T.font, outline:"none", width:"200px" }}
        ...
        {!loading && tab==="All Transactions" && (
          <div style={{ ...cardMd(), overflow:"hidden" }}>
            <div style={{ padding:"18px 24px", borderBottom:`1.5px solid ${T.border}`, display:"flex", justifyContent:"space-between", alignItems:"center", background:"#fff" }}>
              ...
              <span style={{ fontSize:"12px", fontFamily:T.fontMono, fontWeight:600, padding:"4px 12px", borderRadius:"99px", background:T.greenLite, color:T.green, border:`1px solid ${T.greenBdr}` }}>{allTxs.length} total</span>
            </div>
            <div style={{ overflowX:"auto" }}>
              <table style={{ width:"100%", borderCollapse:"collapse" }}>
